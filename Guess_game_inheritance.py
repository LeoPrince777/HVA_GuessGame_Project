...
class Game_child(Game):
    def category_dic(self):
        ...
        self.Categories = { "birds" :{'parrot': "I am a bird; I am green in color and have reddish beak",
                                      'peacock': "I am a bird. I am colorful and known as the national bird of India",
                                      'hen': "I am a domestic bird and give you eggs for omelete"},
                            "reptiles" :{'crocodile': "I am a reptile; I am brownish green in colour, big in size and live in water.",
                                          'snake': "I am a reptile. I make a hiss sound and can move without any legs",
                                          'lizard': "I am a reptile; I live in most houses and I can easily crawl on the walls"},
                            "insects" :{'bee': "I am an insect and I help with pollination and collect honey",
                                         'mosquito': "I am an insect and I drink blood and spread disease",
                                        'butterfly': "I am an insect and I have beautiful wings and I love nectar"}  
                          }
    ...
    def play(self):
        ...
        for i in self.Categories:
            animal = random.choice(list(self.Categories.keys()))
            randomanimal = random.choice(list(self.Categories[animal].keys()))
            print(f"\nGuess the {animal} based on the following hint:")
            print(self.Categories[animal][randomanimal])
